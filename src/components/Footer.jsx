...
function Footer() {
  return (
    <footer className=' left-0 w-full pt-8 bg-slate-700 h-1/4 '>
      <div className="grid grid-row-1 justify-items-center ">
          <div>
          ...
          <div> 
             <p className='text-md mt-2'> copyright &copy; All Rights reserved</p>
          </div>
      </div>
    </footer>
  )
